...
//            TO SEE IMMIDIATELY THE RECORD!
    ...
    public void insertImage(){
        ...
        if(file != null && file.exists()){
            ...
            Image image = new Image(file.toURI().toString(), 85, 85, false, true);
            circle.setFill(new ImagePattern(image));
            changeProfile();
        } else {
            System.out.println("File not found or null");
            // Tindakan untuk gambar yang tidak ditemukan
            // Contoh: Set gambar default atau tampilkan dialog error
        }
    }
...
public void displayImage(){
    if(User.path != null && !User.path.isEmpty()){
        File file = new File(User.path);
        if(file.exists()){
            String uri = "file:" + User.path;
            Image image = new Image(uri, 85, 85, false, true);
            circle.setFill(new ImagePattern(image));
        } else {
            System.out.println("File not found at: " + User.path);
            // Tindakan untuk gambar yang tidak ditemukan
            // Contoh: Set gambar default atau tampilkan dialog error
        }
    } else {
        System.out.println("Path is null or empty");
        // Tindakan untuk path yang null atau kosong
        // Contoh: Set gambar default atau tampilkan dialog error
    }
...
public void insertImageData(){
    ...
    if(file != null && file.exists()){
        ...
        System.out.println("No data exist or file not found");
        // Tindakan untuk gambar yang tidak ditemukan
        // Contoh: Set gambar default atau tampilkan dialog error
    }
}
...
//        THE STUDENT ID HERE IS THE REFERENCE TO KNOW THE TARGET THAT YOU WANT TO DELETE
