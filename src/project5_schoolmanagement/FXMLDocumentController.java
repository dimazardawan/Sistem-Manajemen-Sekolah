    ...
    public void login(){
        ...
        try{
            ...
            if(result.next()){
                ...
                User.path = result.getString("email");
...
//        String sql = "SELECT count(image) FROM account WHERE image != ''";
        ...
        try{
            ...
            if(result.next()){
                ...
                String count = result.getString("count(username)");
            ...
            alert.setHeaderText("Error executing the SQL query");
        ...
        try{
            ...
            if(su_username.getText().isEmpty() 
                ...
                if(validationEmail()){
                    ...
                    String uri = "C:\\Program Files\\Java\\School-Management-System-project2-main\\Project5_SchoolManagement\\src\\project5_schoolmanagement\\logo.jpg";
